(function (global, factory) {
	...
	(factory((global.graphtools = {}),global.lodash));
...
var Graph = (function () {
    ...
    Graph.prototype.sources = function () {
        var _this = this;
        return this.nodes().filter(function (v) { return lodash.isEmpty(_this.in[v]); });
    };
    Graph.prototype.sinks = function () {
        var _this = this;
        return this.nodes().filter(function (v) { return lodash.isEmpty(_this.out[v]); });
    };
    ...
    Graph.prototype.neighbors = function (v) {
        ...
        if (preds) {
            return lodash.union(preds, sucs);
        }
        return undefined;
    };
...
//# sourceMappingURL=graphtools.umd.js.map
